    ...
    with open(filename, 'r') as f:
        ...
        for j in range(len(json_data)):
            examples.append(
                Example(
                        idx = idx,
                        source=json_data[j]["code"]["buggy_code"],
                        target=json_data[j]["code"]["fixed_code"],
...
def convert_examples_to_features(examples, tokenizer, args,p_desc_path,stage=None):
    ...
    for example_index, example in enumerate(examples):
        ...
        source_tokens =[tokenizer.cls_token]+p_desc_tokens+[tokenizer.sep_token]+source_tokens+[tokenizer.eos_token]
...
def main():
    ...
    config = AutoConfig.from_pretrained("huggingface/CodeBERTa-small-v1")
    tokenizer = AutoTokenizer.from_pretrained("huggingface/CodeBERTa-small-v1")
    
    #budild model
    encoder = RobertaModel.from_pretrained("huggingface/CodeBERTa-small-v1")
